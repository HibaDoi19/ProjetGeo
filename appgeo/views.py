...
def add(request):
                ...
                return render( request   ,'result.html', {'result1': res1 ,'result2': res2 ,'result3': res3 ,'plot':ploot.ellipsoide(longitude1,latitude1, alpha1, s, x, y)} )
...
def ellitra(longitude1 , latitude1,alpha1,s,a,b):
                ...
                return fig.add_scatter3d(x=x,y=y,z=z,mode='lines',marker ={'color':'red'})
"""class Graph( template_doc):
        ...
        def get_context_data(self,**kwargs):
                ...
                X = cos(theta) * sin(phi) * 6378137
                Y = cos(theta) * cos(phi) * 6378137

                Z = sin(theta)*6356752.314245
                layout = go.Layout(width = 700, height =700,title_text='Géodesique')
